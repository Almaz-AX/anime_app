      ...
      builder: (context, state) {
        switch (state.status) {
          ...
          case UnderseenEpisodesStatus.success:
            ...
            return const _UnderseenEpisodesWidget();
        }
      },
    );
  }
...
class _UnderseenEpisodesWidget extends StatelessWidget {
  const _UnderseenEpisodesWidget({
    super.key,
  });

  @override
  Widget build(BuildContext context) {
    final state = context.watch<UnderseenEpisodesBloc>().state;
    return Column(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              for (Release release in state.underseenReleases) {
                if (release.id == state.underseenEpisodes[index].releaseId) {
